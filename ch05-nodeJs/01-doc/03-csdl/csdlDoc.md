...
- Schema(cấu trúc - table) chặt chẽ , -- ko cần schema cũn đc vì nó ko tăng về chiều ngang
...
- Không cần Schema ==> doc ban đầu
- Rất cần Schema,vì tính có thể thêm nhiều thuộc tính nên phải mô tả kĩ để chặn hacker, lưu được hầu như bất cứ thứ gì
