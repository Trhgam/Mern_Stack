...
// việc code trong file js là đg coded trong object window
...
profile.height = 170;
// const profile = {name: "Toàn", height : 190 } lỗi  =>vì đang thay địa chỉ rồi chứ ko  thay đổi mỗi giá trị nữa
// hằng số này lưu dãy số  dẫn tới vùng nhớ chứa object, nên thay đổi giá trị trong vùng nhớ ,nó ko thay đổi địa chỉ
